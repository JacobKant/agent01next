...
Когда обращаешься к инструменту rag-search и используешь информацию из него, потом всегда подписывай источник информации. Документ номер чанка индекс начало и конец отрывка.
`;
